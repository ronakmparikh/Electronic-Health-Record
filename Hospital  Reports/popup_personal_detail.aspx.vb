...
Partial Class popup_personal_detail
    ...
    Protected Sub btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsubmit.Click
        ...
        If (Chkaggrement.Checked = True) Then
            ...
            Try
                ...
                Dim permission As MsgBoxResult
                permission = MsgBox("Do you want to Fill Information", MsgBoxStyle.YesNo)
                If (permission = MsgBoxResult.Yes) Then
                    Response.Redirect("~/Member Page_detail/Profissional.aspx")
                Else
    ...
    Protected Sub ddlyear_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlyear.SelectedIndexChanged
        txtage.Text = Now.Year - ddlyear.SelectedValue
