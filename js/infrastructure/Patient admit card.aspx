...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="603px" Width="956px">
    
    
    
    
    <div class="style1" style="background-color: #ff9900">
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="LinkButton13" runat="server" Font-Bold="True" 
                        Font-Size="Small" 
                        PostBackUrl="~/infrastructure/popup_personal_detail.aspx">Not Registerd 
                    Patient</asp:LinkButton>
                </td>
                <td>
                    &nbsp;</td>
                <td>
