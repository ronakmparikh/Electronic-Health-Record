    ...
    <br />
        ...
        <asp:Label ID="Label30" runat="server" Font-Names="Arial" Font-Size="Small" 
            ForeColor="Blue" Text="Registration and QCC"></asp:Label>
                ...
                <td class="style3">
        <asp:DropDownList ID="ddlregistration_qcc" runat="server">
            <asp:ListItem>Shops And Establshment</asp:ListItem>
            <asp:ListItem>Fire Dapartment</asp:ListItem>
            <asp:ListItem>NABH</asp:ListItem>
            <asp:ListItem>JCI</asp:ListItem>
