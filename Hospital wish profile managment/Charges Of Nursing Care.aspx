<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Charges Of Nursing Care.aspx.vb" Inherits="Default3" %>



<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel_of_doctor_home_page" runat="server" Height="518px" 
        Width="1171px">
<asp:LinkButton ID="LinkButton1" runat="server" 
            PostBackUrl="~/Link Page/Link Page.aspx" CausesValidation="False" 
            Font-Bold="True">HOME</asp:LinkButton>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <center><asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="CHARGES OF NURSING CARE" BackColor="#009900"></asp:Label></center>
        <br />
        <br />
        <table class="style1">
            <tr>
                <td class="style2">
            <asp:Label ID="Label16" runat="server" ForeColor="Blue" Text="Code:-" 
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ...
            <asp:Label ID="Label6" runat="server" Text="Particular:-" ForeColor="Blue" 
            Font-Bold="True" Font-Size="Small"></asp:Label>
            &nbsp;&nbsp;&nbsp;
                </td>
                <td class="style5">
            <asp:TextBox ID="txtparticular" runat="server" Width="358px" Height="22px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ControlToValidate="txtparticular" ErrorMessage="*" 
            ToolTip="Feild Cannot Be Left Blank"></asp:RequiredFieldValidator>
                </td>
                <td class="style6">
            <asp:Label ID="Label7" runat="server" ForeColor="Blue" Text="Rate:-" 
            Font-Bold="True" Font-Size="Small"></asp:Label>
            &nbsp;
                </td>
                <td>
