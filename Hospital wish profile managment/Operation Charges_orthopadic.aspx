<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Charges_orthopadic.aspx.vb" Inherits="Default16" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
     <center>   <asp:Label ID="Label18" runat="server" 
            Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="OPERATION CHARGES: ORTHOPADIC SURGERY" 
        ...
        <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Size="Small" 
            ForeColor="Blue" Text="Particulas:-"></asp:Label>
                ...
                <td class="style5">
                    <asp:TextBox ID="txtparticular" runat="server" Width="478px" Height="22px"></asp:TextBox>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button9" runat="server" Text="Update" 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button10" runat="server" 
            Text="Search" BackColor="#009900" ForeColor="White" style="height: 26px" 
