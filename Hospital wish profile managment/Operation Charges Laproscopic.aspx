<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Charges Laproscopic.aspx.vb" Inherits="Default21" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      <center>  <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" 
            Text="OPERATION CHARGES: LAPROSCOPIC , THOROCOSCOPIC , ENDOSCOPIC SURGERY" 
        ...
        <asp:Label ID="Label25" runat="server" Font-Bold="True" Font-Size="Small" 
            ForeColor="Blue" Text="Particulas:-"></asp:Label>
                ...
                <td class="style5">
                    <asp:TextBox ID="txtparticular" runat="server" Width="408px" 
