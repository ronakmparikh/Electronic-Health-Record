<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Charges Opthalmic.aspx.vb" Inherits="Default19" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      <center>  <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="OPERATION CHARGES: OPTHALMIC SURGERY" 
...
<br /> 
        <center>
        <asp:Button     ID="Button7" runat="server" Text="Insert" Width="58px" BackColor="#009900" 
            ForeColor="White" />
