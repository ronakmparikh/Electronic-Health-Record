<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Chages Vascular.aspx.vb" Inherits="Default25" %>



<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel_of_doctor_home_page" runat="server" Height="478px" 
        Width="1171px">
<asp:LinkButton ID="LinkButton1" runat="server" 
            PostBackUrl="~/Link Page/Link Page.aspx" CausesValidation="False" 
            Font-Bold="True">HOME</asp:LinkButton>
       <center> <asp:Label 
            ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="OPERATION CHARGES VASCULAR SURGERY" 
        ...
        <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" 
            ForeColor="Blue" Text="Particulas:-"></asp:Label>
                ...
                <td class="style5">
                    <asp:TextBox ID="txtparticular" runat="server" Width="338px" 
            Height="22px"></asp:TextBox>
...
<asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" 
            ...
            CellSpacing="2" Width="1181px" Height="161px">
