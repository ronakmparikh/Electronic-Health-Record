...
Partial Class Default17
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            insert = "insert into ot_general values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + txtparticular.Text + "','" + ddlgrade.SelectedValue + "')"
    ...
    Protected Sub Button8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from ot_general where code='" + txtcode.Text + "'"
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        con.cn.Open()
        Try
            search = "select * from ot_general where code= '" + txtcode.Text + "' "
            da = New SqlDataAdapter(search, con.cn)
            da.Fill(ds, "ot_general")
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        upd = "update ot_general set code= '" + txtcode.Text + "',particulars='" + txtparticular.Text + "',grade='" + ddlgrade.SelectedValue + "' where code= '" + txtcode.Text + "'"
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from ot_general where Hospital_id = '" + Session("provide_org_user_id") + "'"
