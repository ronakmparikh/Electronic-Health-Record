...
Partial Class _Default
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            insert = "insert into body_fluids values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + txtservice.Text + "'," + txtcharges.Text + ")"
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from body_fluids where Code='" + txtcode.Text + "'"
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        con.cn.Open()
        Try
            search = "select * from body_fluids where Code= '" + txtcode.Text + "' "
            da = New SqlDataAdapter(search, con.cn)
            da.Fill(ds, "body_fluids")
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        upd = "update body_fluids set Code= '" + txtcode.Text + "',Service='" + txtservice.Text + "',Rate=" + txtcharges.Text + " where Code= '" + txtcode.Text + "'"
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from body_fluids where Hospital_id = '" + Session("provide_org_user_id") + "'"
