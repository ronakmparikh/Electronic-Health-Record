...
Partial Class Default32
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            insert = "insert into nephrology values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + txtservice.Text + "','" + ddltype_of_room.SelectedValue + "'," + txtrate.Text + ")"
    ...
    Protected Sub Button8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from nephrology where code='" + txtcode.Text + "'"
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        con.cn.Open()
        Try
            search = "select * from nephrology where code= '" + txtcode.Text + "' "
            da = New SqlDataAdapter(search, con.cn)
            da.Fill(ds, "nephrology")
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        upd = "update nephrology set code= '" + txtcode.Text + "',service='" + txtservice.Text + "',type_room='" + ddltype_of_room.SelectedValue + "',rate=" + txtrate.Text + " where code= '" + txtcode.Text + "'"
    ...
    Protected Sub Button11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button11.Click
        txtcode.Text = ""
        txtservice.Text = ""
        ddltype_of_room.SelectedValue = "selected"
        txtrate.Text = ""
    End Sub
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from nephrology where Hospital_id = '" + Session("provide_org_user_id") + "'"
