<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Charges Neurology.aspx.vb" Inherits="Default22" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
       ...
       <center> <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="OPERATION CHARGES: NEUROLOGY SURGERY" 
