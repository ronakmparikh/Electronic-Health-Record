...
Partial Class Default31
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            insert = "insert into gastro values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + txtservice.Text + "','" + ddltype_of_room.SelectedValue + "'," + txtrate.Text + ")"
    ...
    Protected Sub Button8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from gastro where code='" + txtcode.Text + "'"
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        con.cn.Open()
        Try
            search = "select * from gastro where code= '" + txtcode.Text + "' "
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        upd = "update gastro set code= '" + txtcode.Text + "',service='" + txtservice.Text + "',type_room='" + ddltype_of_room.SelectedValue + "',rate=" + txtrate.Text + " where code= '" + txtcode.Text + "'"
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from gastro where Hospital_id = '" + Session("provide_org_user_id") + "'"
