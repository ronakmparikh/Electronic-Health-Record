...
Partial Class Default13
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            insert = "insert into grade values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + ddlgrade.SelectedValue + "','" + ddlclass.SelectedValue + "'," + txtrate.Text + ")"
    ...
    Protected Sub Button8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from grade where code='" + txtcode.Text + "'"
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        con.cn.Open()
        Try
            search = "select * from grade where code= '" + txtcode.Text + "' "
            da = New SqlDataAdapter(search, con.cn)
            da.Fill(ds, "grade")
            txtcode.Text = ds.Tables(0).Rows(0)(1)
            ddlgrade.SelectedValue = ds.Tables(0).Rows(0)(2)
            ddlclass.SelectedValue = ds.Tables(0).Rows(0)(3)
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        upd = "update grade set code='" + txtcode.Text + "', grade= '" + ddlgrade.SelectedValue + "',class='" + ddlclass.SelectedValue + "',rate=" + txtrate.Text + " where code= '" + txtcode.Text + "'"
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from grade where Hospital_id = '" + Session("provide_org_user_id") + "'"
