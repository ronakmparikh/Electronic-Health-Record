...
Partial Class Default26
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            insert = "insert into surgery_charges values('" + Session("provide_org_user_id") + "','" + txtcode.Text + "','" + txtparticular.Text + "','" + ddlgrade.SelectedValue + "')"
    ...
    Protected Sub Button8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con.cn.Open()
        Try
            delete = "delete from surgery_charges where code='" + txtcode.Text + "'"
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        con.cn.Open()
        Try
            search = "select * from surgery_charges where code= '" + txtcode.Text + "' "
            da = New SqlDataAdapter(search, con.cn)
            da.Fill(ds, "surgery_charges")
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        upd = "update surgery_charges set code= '" + txtcode.Text + "',particulars='" + txtparticular.Text + "',grade='" + ddlgrade.SelectedValue + "' where code='" + txtcode.Text + "'"
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from surgery_charges where Hospital_id='" + Session("provide_org_user_id") + "'"
