<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Surgery Charges Oraland.aspx.vb" Inherits="Default27" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
        ...
        <center><asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="SURGERY CHARGES ORAL AND MAXILLOFACILA" 
        ...
        &nbsp;&nbsp;
                ...
                <td class="style4">
        <asp:TextBox ID="txtparticular" runat="server" Width="338px" Height="22px"></asp:TextBox>
        ...
        &nbsp;<asp:DropDownList ID="ddlgrade" runat="server" Height="22px">
            ...
            <asp:ListItem>9</asp:ListItem>        </asp:DropDownList>
