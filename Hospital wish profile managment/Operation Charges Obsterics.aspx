<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="Operation Charges Obsterics.aspx.vb" Inherits="Default18" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
     ...
     <center>   <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="OPERATION CHARGES: OBSTERICS &amp; GYNAECOLOGY" 
