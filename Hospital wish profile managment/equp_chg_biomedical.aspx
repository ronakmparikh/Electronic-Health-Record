<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="equp_chg_biomedical.aspx.vb" Inherits="Hospital_wish_profile_managment_equp_chg_biomedical" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <center> <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="X-Large" 
            ForeColor="White" Text="EQUIPMENT CHARGES: BIO-MEDICAL SERVICES" 
...
&nbsp;</td>
                <td class="style6">
                    <asp:TextBox ID="txtrate2" runat="server" Height="22px" Width="121px"></asp:TextBox>
