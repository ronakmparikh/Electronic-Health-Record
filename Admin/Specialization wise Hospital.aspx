<%@ Page Language="VB" MasterPageFile="~/Admine.master" AutoEventWireup="false" CodeFile="Specialization wise Hospital.aspx.vb" Inherits="Admin_Specialization_wise_Hospital" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel6" runat="server" Height="186px" Width="1177px">
        ...
        <asp:Label ID="lblpersonal_details" runat="server" BackColor="#009900" 
            ...
            Text="Specialization Wise Hospital"></asp:Label>
        &nbsp;<br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<center>
        ...
        ForeColor="White" Text="View Report" 
                PostBackUrl="~/Admin Report/Specialization wise Hospital.aspx" /></center> 
    &nbsp;<br />
</asp:Panel>
</asp:Content>
