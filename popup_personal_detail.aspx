...
<body background="#ff9933" bgcolor="#ff9933">
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
            ...
            Height="22px" Width="121px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
    ...
    <asp:TextBox ID="txtage" 
        runat="server" Width="121px" MaxLength="3" Height="22px" AutoPostBack="True"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                     <td class="style4">
    ...
    <asp:DropDownList ID="ddlmarital_status" runat="server" 
            ...
            <asp:ListItem Value="Saparated">Separated</asp:ListItem>
...
&nbsp;&nbsp;&nbsp;
          <asp:CheckBox ID="Chkaggrement" runat="server" Font-Bold="True" 
              Text="I Have read the terms and condition and accept the same save" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
