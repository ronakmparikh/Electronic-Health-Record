<%@ Page Language="VB" MasterPageFile="~/login_hospital.master" AutoEventWireup="false" CodeFile="edit_profile.aspx.vb" Inherits="Link_Page_edit_profile" title="Untitled Page" %>
            ...
            <tr>
                <td style="text-align: center" class="style19">
                    <asp:Label ID="lbl_heading" runat="server" BackColor="#009933" Font-Bold="True" 
                        ...
                        style="text-align: center" Text="EDIT PROFILE"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
