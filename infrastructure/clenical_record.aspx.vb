...
Partial Class infrastructure_clenical_record
    ...
    Sub shows()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from Prescription where Patient_id= '" + ddlpatientid.SelectedValue + "'"
    ...
    Sub shows1()
        ...
        con.Connection()
        con.cn.Open()
        show = "select * from Clinical_record where Patient_id= '" + ddlpatientid.SelectedValue + "' and Hospital_id= '" + Session("provide_org_user_id") + "'"
        da = New SqlDataAdapter(show, con.cn)
        ds = New DataSet()
        da.Fill(ds)
