...
Partial Class infrastructure_Misc_chg
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            auto()
            insert = "insert into test_form values('" + Session("provide_org_user_id") + "','" + Session("misc_chg") + "','" + Session("recpt_no") + "','" + txtdate.Text + "','" + ddlpatientid.SelectedValue + "','" + ddldoctorid.SelectedValue + "','" + Label8.Text + "','" + DropDownList1.SelectedValue + "','" + DropDownList2.SelectedValue + "'," + DropDownList3.SelectedValue + ")"
    ...
    Sub auto()
        ...
        Session("misc_chg") = "Hospital00" + count
        con.cn.Close()
    End Sub
